...
import com.hospital.jpa.CategoryTypeRepository;
...
public class AdminContoller {
	...
	public String saveDoctor(@Valid @ModelAttribute("doctor") Doctor doctor, BindingResult bResult, Model m,
	...
	@GetMapping("category")
	public String createcategory(HttpServletRequest req, Model m) {
		m.addAttribute("categoryType", new CategoryType());
		List categoryTypeList = categoryTypeRepository.findAll();
		m.addAttribute("categoryTypeList", categoryTypeList);
		return "category";
	}
	@GetMapping("master")
	public String createMaster(HttpServletRequest req, Model m) {
		m.addAttribute("categoryType", new CategoryType());
		List categoryTypeList = categoryTypeRepository.findAll();
		m.addAttribute("categoryTypeList", categoryTypeList);
		return "master";
	...
	public String deletecategorymaster(@RequestParam("selectId") long theId) {
		//Optional<Master> master = categoryTypeRepository.findById(theId);
		//Master s = master.get();
		//masterRepository.delete(s);
		return "redirect:/admin/doctersmaster";
	}
	@PostMapping("addCategory")
	public String addCategory(@ModelAttribute("categoryType") CategoryType categoryType, Model m, HttpServletRequest req) {
