    ...
    <section class="loginContainer">
        ...
        <div class="rightPanel">
            <form action="loginSubmit" class="loginForm" method="post">
                <div class="digilogo" style="width:120px; text-align:center;padding-bottom:30px; margin:0 auto"><img src="${pageContext.request.contextPath}/jsp/patient/images/digiklinik.png" style="width:130px"/></div>
        <h2>Admin Sign In</h2>
