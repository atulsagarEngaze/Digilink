...
function  validate_register_form(){
	var email_mobile = $('#txtMobile').val();
        ...
        <div class="patientRight">
            ...
            <div id="loginSection" class="tabSec">
                ...
                <form action="loginSubmit" method="post"  onsubmit="return validateForm()">
                    ...
                    <input type="text" name="mobile" id="mobile" placeholder="Mobile Number/ Email ID" class="form-control mb-15">
                ...
                <form>
                    ...
                    <div class="row mb-15">
                       <!--  <div class="col-xs-3">
                        ...
                        <div class="col-xs-12">
                            <input type="text" name="mobile" id="txtMobile" placeholder="Enter Mobile" class="form-control">
                        </div>
                    </div>
                    <label for="">Create Password</label>
                    <input type="text" name="password" id="txtPassword" placeholder="Enter Password" class="form-control mb-15">
                    <div class="row mb-15">
                        <div class="col-xs-12">
            ...
            <h4 style="line-height:24px">
                A confirmation link has been sent to <div id="emailVerify">a</div>. Click on the link sent to verify your account.
            </h4>
			<p>&nbsp;</p>
