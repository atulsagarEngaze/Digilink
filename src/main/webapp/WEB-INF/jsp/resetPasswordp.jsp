...
<body>
    ...
    <section class="patientLoginContainer">
        ...
        <div class="patientRight">
            ...
            <input type="text" name="newpass" id="newpass" placeholder="New Password" class="form-control mb-15">
            <label for="">Confirm New Password</label>
            <input type="text" name="newpassconfirm" id="newpassconfirm" placeholder="Confirm New Password" class="form-control mb-15">
