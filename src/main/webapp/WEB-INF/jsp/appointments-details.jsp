      ...
      <section class="dataContainer" style="margin: 53px 0px 0px 0px;">
       <!-- <div class="pageHeader">
		...
		<div class="dataSection pt-50">
			...
			<div class="ptdetails">
				<div class="col-md-6">
				<h4><img src="${pageContext.request.contextPath}/jsp/patient/images/calendar-icon.jpg"> On Jun 05, 2020</h4>
				<a href="#">Change Date & Time</a></p>
				</div>
				
				<div class="col-md-6">
				<h4><img src="${pageContext.request.contextPath}/jsp/patient/images/time-icon.jpg"> At 05:30 PM</h4>
				</div>
...
<p class="mt-50"><a href="dashboardp.html">Go back to my results</a></p>
			...
			<div class="col-md-6">
			<h1 class="cancelledheading">Appointment Cancelled</h1>
			<h4 style="line-height:28px;">Your appointment ID is <b>DIGI01</b>,<br> We have sent you an email and SMS with the details.</h4>
