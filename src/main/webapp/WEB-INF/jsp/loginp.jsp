        ...
        <div class="patientRight">
            ...
            <div id="loginSection" class="tabSec">
                ...
                <form  action="loginSubmit" method="post" onsubmit="return validateForm();">
                    ...
                    <input type="text" name="mobile" id="txtMobile" placeholder="Mobile Number/ Emai ID" class="form-control mb-15">
                   
                    <label for="">Password</label><small>${email}</small>
                    
                    <input type="password" name="pwd" id="txtPwd" placeholder="Password" class="form-control mb-15">
                    <small>${pwd}</small>
                    <div class="row mb-15">
                        <div class="col-xs-6">
