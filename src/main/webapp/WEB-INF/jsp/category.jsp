...
<body>
 ...
 <section class="dataContainer">
        ...
        <div class="addSpeciality">
        	...
        	<form:form action="/admin/addCategory" method="POST" modelAttribute="categoryType" width="800px" >
        	...
        	<div class="col-sm-5">
        	<form:input type="text" path="sub_category" class="form-control mr-10 max-300" placeholder="Enter Category"/>
           
        	
        
        </div>
            
        	<button class="btn btn-primary" id="addCategory">Add</button>
            </form:form>
        </div>
